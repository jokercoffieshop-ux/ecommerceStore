...
"[project]/Downloads/coffe-project/pages/api/categories/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function handlePut(req, res, id) {
    try {
        ...
        const existingCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].category.findUnique({
            where: {
                id: parseInt(id)
            }
        });
        ...
        if (files.image) {
            ...
            if (existingCategory.imageUrl) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFile"])(existingCategory.imageUrl);
            }
        ...
        // تحديث الفئة
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].category.update({
            where: {
                id: parseInt(id)
            },
            data: {
 ...
 */ async function handleDelete(req, res, id) {
    try {
        ...
        if (category.imageUrl) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFile"])(category.imageUrl);
        }
        // حذف الفئة
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].category.delete({
            where: {
                id: parseInt(id)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23100f1d._.js.map