...
"[project]/Downloads/coffe-project/pages/api/orders/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        // جلب الطلب
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].order.findUnique({
            where: {
                id: parseInt(id)
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__137c7429._.js.map