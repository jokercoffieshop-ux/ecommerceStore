...
"[project]/Downloads/coffe-project/pages/api/products/index.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function handleGet(req, res) {
    try {
        const { search, categoryId, isAvailable, minPrice, maxPrice, page = 1, limit = 12, sortBy = "createdAt", sortOrder = "desc" } = req.query;
        // بناء شروط البحث
        const where = {};
        if (search) {
            where.OR = [
        ...
        const [products, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.findMany({
                where,
                skip,
                take,
                orderBy: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.count({
                where
            })
        ]);
 ...
 */ async function handlePost(req, res) {
    try {
        ...
        // إنشاء المنتج
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.create({
            data: {
                nameAr,
                nameEn: nameEn || null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0d4959e._.js.map