...
"[project]/Downloads/coffe-project/pages/api/products/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function handlePut(req, res, id) {
    ...
    try {
        ...
        const existingProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.findUnique({
            where: {
                id: parseInt(id)
            }
        });
        ...
        const { nameAr, nameEn, descriptionAr, descriptionEn, price, categoryId, stock, isAvailable, size, weight, sku } = fields;
        // التحقق من الفئة إذا تم تغييرها
        if (categoryId && parseInt(categoryId) !== existingProduct.categoryId) {
            const category = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].category.findUnique({
                where: {
        ...
        if (cloudinaryResults.image) {
            ...
            if (existingProduct.imagePublicId) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFromCloudinary"])(existingProduct.imagePublicId);
                } catch (deleteError) {
        ...
        // تحديث المنتج
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.update({
            where: {
                id: parseInt(id)
            },
            data: {
        ...
        if (newImagePublicId) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFromCloudinary"])(newImagePublicId);
            } catch (cleanupError) {
 ...
 */ async function handleDelete(req, res, id) {
    try {
        ...
        if (product.imagePublicId) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFromCloudinary"])(product.imagePublicId);
            } catch (deleteError) {
        ...
        // حذف المنتج
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].product.delete({
            where: {
                id: parseInt(id)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31901001._.js.map