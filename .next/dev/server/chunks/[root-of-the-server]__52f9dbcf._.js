        ...
        try {
            ...
            if (!validation.success) {
                ...
                if (cloudinaryResults.avatar?.public_id) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFromCloudinary"])(cloudinaryResults.avatar.public_id);
                }
            ...
            if (cloudinaryResults.avatar) {
                ...
                updateData.avatarUrl = cloudinaryResults.avatar.secure_url || (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["getCloudinaryUrl"])(cloudinaryResults.avatar);
                updateData.avatarPublicId = uploadedPublicId;
                // Delete old avatar from Cloudinary if exists
                if (currentUser.avatarPublicId) {
                    try {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$upload$2e$js__$5b$api$5d$__$28$ecmascript$29$__["deleteFromCloudinary"])(currentUser.avatarPublicId);
                    } catch (deleteError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52f9dbcf._.js.map