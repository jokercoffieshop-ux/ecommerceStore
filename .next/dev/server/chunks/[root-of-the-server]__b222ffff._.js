...
"[project]/Downloads/coffe-project/pages/api/cart/items/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function handlePut(req, res, id) {
    try {
        ...
        const cartItem = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].cartItem.findUnique({
            where: {
                id: parseInt(id)
            },
            include: {
        ...
        // تحديث الكمية
        const updatedItem = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].cartItem.update({
            where: {
                id: parseInt(id)
            },
            data: {
 ...
 */ async function handleDelete(req, res, id) {
    try {
        ...
        // حذف العنصر
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].cartItem.delete({
            where: {
                id: parseInt(id)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b222ffff._.js.map