...
"[project]/Downloads/coffe-project/pages/api/auth/verify-otp.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].user.update({
            where: {
                id: user.id
            },
            data: {
        ...
        // Delete used OTP
        await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$coffe$2d$project$2f$lib$2f$prisma$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].otp.delete({
            where: {
                id: otp.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8df6a9a0._.js.map